...
import SignaturePad, * as SignaturePadNative from 'signature_pad';
...
export class SignaturePadComponent implements AfterContentInit, OnDestroy {
  ...
  public ngOnDestroy(): void {
    ...
    canvas.height = 0;
    /* prettier-ignore */
    this.signaturePad.removeEventListener('beginStroke', this.onBegin.bind(this))
    this.signaturePad.removeEventListener('endStroke', this.onEnd.bind(this));
  }
